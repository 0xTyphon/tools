const srouce = {
  ...
  footer: {
    cta: {
      ...
      type4: {
        title: '<h3>Get USD without selling your crypto</h3>',
        btn: 'BORROW NOW',
      },
      type5: {
        title: '<h3>Send money anywhere </h3>',
        btn: 'Make a transfer',
      },
      type6: {
      ...
      type10: {
        title: '<h3>Invest the way you want</h3>',
        btn: 'Sign up now',
      },
      type11: {
  ...
  error: {
    ...
    serverCode: {
      ...
      registerWithExistEmail:
        'This email already exists in our system. Please try another.',
      ...
      registerPasswordNotMatch:
        'Please make sure your password matches your email address.',
      notKycUser:
        'Please complete the KYC process to buy direct from the network.',
      ...
      emailDoesntExist:
        'Oops we can\'t find you. Please enter your email address again.',
      needToSignIn: 'You need to sign in to complete this process',
      not_enough_balance: 'Your balance is not enough',
      createdBankExisted: 'Bank account has existed already!',
      trial_term_deposit_not_available:
        'The Constant introductory trial is only available to new users .',
      not_pro_saving_user:
        'Sorry, we can only offer services in the USA to SEC accredited investors.',
      otpNotMatched: 'Google authentication code not matched, please try again.',
      userDocumentCannotChange: 'You cannot change KYC information. Please contact admin for support.',
      missingUserDocuments: 'User hasn\'t had any document yet!',
      userFirstNameInvalid: 'FirstName is invalid',
      userLastNameInvalid: 'LastName is invalid',
      userDOBInvalid: 'DOB is invalid',
      userTaxCountryInvalid: 'TaxCountry is invalid',
      ...
      external_api_error: 'You send so many request, please wait and come back later',
      invalidCoupon: 'Invalid coupon code',
      usedCoupon: 'Coupon is used',
      restrictedEmail: 'Email is restricted',
      prvMaxWithdraw: 'Prv is max withdraw',
  ...
  errorCode: {
    ...
    3005: 'Your price must be large than 0',
    ...
    3010: 'You cannot Buy/Sell with yourself',
    3011: 'Please check your Constant',
    3012: 'Please check your bank account name',
    3013: 'Please check your bank account number',
    3014: 'Please check your routing number or swift code',
    3015: 'Please check your bank number',
  ...
  me: {
    ...
    wallet: {
      ...
      walletAddress: 'Your ether wallet: ',
    },
    kyc: {
    ...
    personalProfile: {
      ...
      statusUnverified:
        'Please complete the KYC process to buy direct from the network.',
      statusProcessing:
        'Your KYC information is being processed. We’ll notify you when you’re good to go.',
      statusNeedVerifyEmail: 'Please verify your email first',
      statusPendding:
        'Your KYC information is invalid. Please check your email for instructions.',

      errorsInvalidKYC: 'User info is invalid for KYC pre-validate',
      errorsMissParramKYC: 'User info is not enough to verify KYC',

      saveSuccess: 'Your profile was updated successfully',
      saveFailed: 'Failed while updating your profile, please try again',

      addressInfo:
        'Your address and ID information should match the information in the uploaded image.',
    },
    accountInfo: {
      ...
      alert: {
        ...
        success: 'Your nickname was changed successfully',
        failed: 'Failed',
      },
    ...
    changePassword: {
      ...
      changeFailed:
        'Please make sure you have typed in your old password correctly',
    },
    changeRef: {
      title: 'Change your referral code',
      btnChange: 'Change',
      changeSuccess: 'Your referral code was changed successfully',
      changeFailed: 'Your referral code was changed failed',
    },
    twoFa: {
      ...
      description2Fa:
        'Important actions (withdraw, transfer, etc.) will require you to enter a password via Google Authenticator or Authy.',
    ...
    notificationSetting: {
      ...
      secondaryMarketSetting: {
        ...
        noteOff: `
            ...
            `,
        interestRequired: 'Min rate is required!',
        interest: 'Min rate (APR)',
        interestInRange: 'Min rate must be greater than or equal to {min} and less than or equal to {max}',
        termInRange: 'Max term must be greater than {min} and less than or equal to {max}',
        termRequired: 'Max term is required!',
    ...
    smsSettings: {
      ...
      inputSms: {
        ...
        resendCodeFailed: 'Resend code fail!',
      }
    },
    flexInterestConfig: {
...
`,
    ...
    history: {
      ...
      accept: 'Accept',
      acceptMess: 'Are you sure you want to accept this order?',
      confirm: 'Confirm',
      ...
      risk: {
        bank: 'Have the same bank account with:',
        destination: 'Have the same destination transfer to:',
        trial: 'Have received from trial users:',
    ...
    accountLevel: {
      head_text:
        'Our verification process typically takes just a few minutes. This may take slightly longer outside business hours. Your information will remain 100% private.',
      ...
      lv3desc:
        'To comply with relevant anti-money laundering (AML) and counter-terrorism financing (CTF) laws and regulations.',
      fullName: 'Full Name',
      ...
      alert: {
        ...
        overSMSLimit:
          'You entered wrong verification code 10 times already. Please use the last code sent to your phone to verify.',
    ...
    bankInfo: {
      ...
      desc:
        'Add your bank account details now to receive attractive commission from referral programs and faster payment',
    ...
    addressWalletInfo: {
      emptyAddress: 'You don\'t have any Wallet yet!',
      getWalletFailed: 'Failed while getting user list banks',
      btnAdd: 'Add a new wallet address',
      titleAddWallet: 'Add a new Wallet address',
      titleUpdateWallet: 'Update Wallet address',
      btnSubmit: 'Add Wallet',
      btnUpdate: ' Save',
      btnRemove: ' Delete',
      title: 'Wallets Information',
      desc:
        'Add your bank account details now to receive attractive commission from referral programs and faster payment',
      address: 'Address',
      currency: 'Currency',
      ...
      alert: {
        ...
        wallet_address_in_use:
          'This Wallet address can\'t removing because it is used',
      },
      dialog: {
        update: {
          title: 'Confirm Update',
    ...
    emailVerification: {
      ...
      sendCodeSuccess:
        'Verify code was sent successfully to your email, please check.',
    ...
    phoneVerification: {
      sendCodeSuccess:
        'Verify code was sent successfully to your phone, please check.',
      sendCodeFailed: 'Failed while sending verify code, please try again!',
      verifyFailed: 'Verify failed, please try again!',
      verifySuccess:
        'Your phone was verified successfully, now your level is Level 2',
    },
    kycVerification: {
      pleaseComplete: 'Please complete the KYC process to {action}.',
      complete: 'Complete KYC',
      pleaseKYCBeforeAction:
        'For your security, we’ll need you to verify your ID before {action}.',

      updatedSuccess: 'Your information was updated successfully',
      updatedFailed:
        'Failed while updating your information, please try again!',
    ...
    proSaving: {
      listApplications: {
        ...
        noLoans: 'You don\'t have any loans',
        noInvestment: 'You don\'t have any investment',
        totalInterestEarned: 'You\'ve already earned',
        noRecord: 'You have no invest',
        getListFailed: 'Failed while getting your invests, please try again',
        ...
        dialog: {
          ...
          autoTopup: {
            ...
            autoTopUpCollateralSuccess: {
              ...
              false: 'Turn auto top up off successfully'
            },
          ...
          autoRenew: {
            ...
            autoRenewCollateralSuccess: {
              true: 'Turn auto renew on successfully',
              false: 'Turn auto renew off successfully'
            },
          ...
          withdrawAccount: {
            title: 'Saving',
            body:
              'Want to multiply your returns? Commit any amount for any time horizon.',
            ...
            validateMaxAmountError:
              'Sorry, you don\'t have enough Constant to deposit this amount.',
            validateMinAmountError:
              'You can\'t input amount less than {amount} CONSTANT',
          },
          checkTrialKyc: {
            messageConfirm:
              'For your security, please verify your identity before making a withdrawal from your Anytime Account.',
            confirm: 'Verify my ID',
            cancel: 'Maybe later',
          },
          cancelDeposit: {
            messageConfirm:
              'Are you sure you want to cancel your deposit order?',
            confirm: 'Yes, cancel',
            cancel: 'Go back',
          },
          deleteInvestment: {
            messageConfirm:
              'Are you sure you want to delete your investment order?',
            confirm: 'Yes',
            cancel: 'Go back',
          },
          cancelInvestment: {
            messageConfirm:
              'Are you sure you want to cancel your investment order before a match is found?',
            confirm: 'Yes, cancel',
            cancel: 'Go back',
          },
          ...
          cancelDepositKyc: {
            messageConfirm:
              'To activate this investment order, all you need to do is verify your ID. Cancel anyway?',
            confirm: 'Yes, cancel',
            cancel: 'Verify my ID',
          },
          getRemainCollateral: {
        ...
        rewardFrom: {
          ...
          rewardSubTile: 'You can apply a maximum of {maxRate} STAR per redemption.',
      ...
      applicationDetail: {
        ...
        requireTopup:
          'You balance ({balance}) not enough to pay {amount}. Top-up now?',
        backBtn: 'Back to list',
        cancel: 'Cancel',
        payForThisTerm: 'Pay for this term',
        getDetailFailed:
          'Failed while getting application detail, please try again',
        cancelSuccessfully: 'Your application was canceled successfully',
        cancelFailed:
          'Failed while canceling your application, please try again',
    ...
    staking: {
      balance: '{name} balance: {balance} {symbol} and balance reward: {reward} {symbol}',
  ...
  'landing_page.label.footer':
    'Constant MVP is an online exchange developed by Shanzhai Limited, a Hong Kong based company, offering bulk crypto purchasing at competitive prices with full delivery service.<br />Join the dojo: <a href="https://t.me/coin_bowl" class="landing-link">t.me/coin_bowl</a><br />Contact us: <a href="mailto:hello@constant.money" class="landing-link" target="_top">hello@constant.money</a>',
  user: {
    kycInformation: 'KYC Information',
    referral: 'Share & Earn $',
    logout: 'Log out',
    ...
    forgetPassword: {
      ...
      description:
        'Please type your email you used to sign in to reset your password. You may need to check your spam folder or unblock hello@constant.money',
      username: 'Your email',
      requiredUsername: 'Email is required',
      notValidUsername: 'Invalid email address',
      submitButton: 'Submit',
      resetPasswordIntro:
        'We have sent a link to your email. Please follow the instruction to sign in with new password',
      ...
      newPasswordIntro:
        'Password of Constant account for {email} has been changed',
      notRecoverPass: 'I can’t recover my account using this page',
    },
    updatePassword: {
      title: 'Update Password',
      description: 'Please type new password for your account.',
      username: 'Your email',
      submitButton: 'Submit',
      password: 'New password',
      requiredPassword: 'Password is required',
    ...
    register: {
      ...
      notValidFirstName:
        'First name must be greater than 3 and less than 30 characters, Allowed characters are a-z, 0-9, _, - (dash), and .(dot).',
      notValidLastName:
        'Last name must be greater than 3 and less than 30 characters, Allowed characters are a-z, 0-9, _, - (dash), and .(dot).',
      email: 'Your email',
      ...
      agreement:
        'I certify that I am 18 years of age or older, and I agree to the {action}',
      requiredAgreement:
        'Please indicate that you have read and agree to the User Agreement and Privacy Policy',
      registerButton: 'Sign up for free',
      loginText: 'Already have an account?',
      loginButton: 'Log in',
      registerSuccessfully:
        'Success! Welcome to Constant. We’ve sent a verification email to your inbox.',
  ...
  home: {
    ...
    blockCap2: 'Enjoy an interest rate 60x the national average.',
    blockDesc2: `
    `,
    blockTitle3: 'What we do',
    blockCap3: 'We’re building a fairer, freer, financial system.',
    titleBlock4: 'Why you should invest with Constant.',
    titleCap4:
      'Our investment options all offer fixed returns, and have different levels of flexibility to choose from. Get your money to work for you.',
    titleDesc4: `
      <p></p>
      <p></p>
    `,
    ...
    stories: {
      quote0:
        'Apart from the bank beating interest rates, this is an incredibly interesting project from a technology standpoint. Banks need to up their game.',
      author0: 'Zen Chang',
      title0: 'Engineer, lover of new fintech projects.',
      quote1:
        'I signed up and made a deposit in under 5 minutes. Great for people who don\'t have the experience or time to invest, but still want to be smart with their money.',
      author1: 'Jerry',
      title1: 'Nurse, investing to help his money go further.',
      quote2:
        'Can\'t rate the Constant support staff highly enough. They walked me through making my first deposit - which was much easier than expected.',
      author2: 'Justin',
    ...
    buy: {
      ...
      subintroDesc1:
        'Pegged to the most stable, useable currency in the world, Constant never loses value.',

      subintroTitle2: 'Fully backed and secured.',
      subintroDesc2:
        'Every Constant is backed by USD, independently held by a US accredited financial custodian, subject to regular audits.',

      subintroTitle3: '100% insured.',
      subintroDesc3:
        'All users are fully FDIC and US treasury insured, regardless of amount.',

      subintroTitle4: 'Borderless. Zero fees.',
      subintroDesc4:
        'Constant moves instantly from your account to anyone, anywhere in the world. For free.',
      ...
      components: {
        ...
        orderInfo: {
          ...
          buyThankMsg:
            'Thanks! Please wire the Constant Trust {amount} to complete your order.',
          sellThankMsg:
            'You sent request convert {amount}. It could be take 30 minutes transfer to your bank account.',
          orderThankMsg:
            'Thanks! Please wire the Constant Trust {amount} USD to complete your order.',
          importantMsg:
        ...
        buy: {
          ...
          headLine:
            'Wire directly to the accredited US Trust Account to get the best rate.',
          purchaseFailed: 'Failed while purchasing, please try again',
          purchaseSuccessful:
            'Success! Your order has been placed. Please proceed payment.',
          inputLabel: 'BUY',
          confirmBuyMsg: 'Are you sure to buy {amount} {currency}?',
          submitLabel: 'GET {amount}',
          pleaseVerifyBtnLabel: 'Verify your account',
          pleaseVerifyBtnMsg:
            'You need to verify your account to start buying/selling',
        ...
        sellBuySkeletonForm: {
          needToVerify:
            'You need to verify your account first to start buy/sell Constant',
        },
        fee: {
          fee: 'fee',
    ...
    convert: {
      ...
      headLine:
        'Get Cash for your Constant from the US network, or exchange locally and avoid international transfer fees.',

      subintroTitle1: 'Protect the value of your money.',
      subintroDesc1:
        ' When your money is Constant, it always keeps its full worth. Constant is 100% backed by USD.',

      subintroTitle2: 'Move your money across the world.',
      subintroDesc2:
        'When you have Constant, you can send it to anyone, anywhere in the world.',

      subintroTitle3: 'Get USD for Constant, anytime.',
      subintroDesc3:
        'Anyone who holds constant can get the equivalent of 1 USD for 1 Constant, that same day.',
      howItWorks: 'How it works',
      max: 'Maximum',
      buy: {
        type: 'Buy',
        ...
        headLine:
          'Don\'t want to make an international wire transfer? Buy locally',
        ...
        orderWithdraw: {
          title: 'Almost there.',
          message:
            'Please wire {amount} so you have sufficient funds in your account to complete the transfer.',
        },
        introHolderTemplate: `
      ...
      sell: {
        ...
        headLine:
          'Sell Constant to local buyers and get cash. No international fees.',
...
`,
    ...
    direct: {
      ...
      subintroDesc2:
        'Constant is fully backed by USD, held by an independent accredited custodian. All users are insured up to 5M USD.',

      subintroTitle3: '3.6% interest on any amount.',
      subintroDesc3:
        'Constant keeps your savings secure and grows your money over time.',
      ...
      components: {
        ...
        orderInfo: {
          ...
          sellTitle: 'Order Confirmation Convert Constant',
          buyThankMsg:
            'Please wire {amount} to Constant Escrow to keep your money safe while the deal finalizes.',
          sellThankMsg:
            'You sent request convert {amount}. It could be take 30 minutes transfer to your bank account.',
          buyAchThankMsg:
            'We are securing your deposit {amount}. Funds will appear in your account in approximately 48 hours, and will begin earning interest from day 1.',
          sellAchThankMsg:
            'You sent request convert {amount}. It could be take 30 minutes transfer to your bank account.',
          orderThankMsg:
            'Thanks! Please wire the Constant Trust {amount} USD to complete your order.',
          ...
          direct: {
            thankYou:
              'Thanks {name}, your funds are on the way to your bank account.',
            content1:
              'There is no Constant Trust in your neighborhood yet, so we\'re sending your money from the main Trust in the USA. As with all international transfers, it may take a couple of days for your investment income to reach you.',
            content2:
              'Thanks for being patient, and thanks again for investing with Constant.',
          },
        },
        buy: {
          purchaseFailed: 'Failed while purchasing, please try again',
          purchaseSuccessful: 'Your purchase was completed successfully',
          inputLabel: 'BUY',
          confirmBuyMsg: 'Are you sure to buy {amount} {currency}?',
    ...
    local: {
      ...
      subintroTitle3: 'Get USD for Constant, anytime.',
      subintroDesc3:
        'Anyone who holds constant can get 1 USD for 1 Constant, that same day.',
      max: 'Maximum',
      total: 'Total',
      buy: {
        type: 'Buy',
    ...
    transfer: {
      ...
      // viaEmailCaption: 'Via Email',
      // viaAddressCaption: 'To an ETH/EOS address',
      // viaTomoCaption: 'To a TOMO address',
      ...
      address: {
        ...
        // wallet: 'Ethereum/EOS wallet address',
        // tomo: 'TOMO wallet address'
      },
      ...
      confirmMsg:
        'Are you sure you want to transfer {amount} CONSTANT to {address}?', //kt
      ...
      subintroDesc2:
        'You can send any amount of Constant to anyone at anytime, for free.',

      subintroTitle3: 'Always reliable.',
      subintroDesc3:
        'Unlike other digital currencies, Constant keeps a stable value. This means you can get the equivalent of 1 USD for 1 Constant. In any location, at any time.',
      backToNewOrder: 'Place new order',
    ...
    loanOriginator: {
      listApplications: {
        ...
        loanOriginatorHeaders: {
          ...
          remainingTermDesc: 'This is the period measured in months and days left until the full repayment of the loan is set.',
    ...
    topBannerSubtext:
      'Hold your money in USD and enjoy free international transfers. 100% insured.',
    ...
    whatDesc1:
      '<p>No matter which commitment period you choose, returns are paid out daily into a Flexible Account. Flexible means you can withdraw whenever you like - or reinvest and make profit on your profit.</p>',

    whatTitle2: 'By the US Government',
    whatTitle3: 'No minimum deposit',
    whatDesc0:
      '<p>Don’t sit on your money. Put it to work. We’re proud of our rates, and we don’t want you to have to wait to enjoy them. Your investment earnings are paid out daily for you to withdraw anytime. </p>',

    whatDesc2:
      '<p>Anyone should have access to better opportunities. Constant is accessible to anyone with an internet connection. Make your first investment in just 15 seconds, anywhere in the world.</p>',
    whatDesc3:
      '<p>You work hard for your money. We make sure it’s taken care of, and you shouldn’t have to pay extra for it. Our Investment Specialists are here to help whenever you need. No commission fees.</p>',
    ...
    whatStudentSubTitle:
      'Sending or receiving funds internationally can be an absolute nightmare. Here’s the solution.',
    ...
    whatStudentDesc0:
      'Constant makes it easier to pay tuition fees, get monthly living expenses, or receive gifts for special occasions. Receive funds from home instantly, for free. You can always convert Constant to USD at any time. 1 Constant = 1 USD, always.',
    whatStudentDesc1:
      'We’re proud of this one. Constant allows you to instantly send your earnings back home, or to anyone, anywhere, at any time. For free. Secured using blockchain technologies, free from centralized control.',
    whatStudentDesc2:
      'Split a dinner bill, pay for room and board, place a fun bet.  With Constant, sending or receiving payments is streamlined, and incurs zero fees.',
    whatStudentDesc3:
      'It’s safe, quick, easy and cost effective to use Constant. Constant is available 24/7 on both web and mobile. No closing times, no bank holidays.',
  },
  static_page: {
  ...
  components: {
    ...
    dialog: {
      checkTrialKyc: {
        messageConfirm:
          'For your security, please verify your identity before {action} from your Account.',
        confirm: 'Verify my ID',
        cancel: 'Maybe later',
        action: {
  ...
  referralPage: {
    title: 'Multiply your investment earnings.',
    description:
      'Earn 6% more on top of what you’re already making <br/> across all your currently active accounts.',
    expirationDate: 'This program begins on March 15 and ends on June 15, 2019',
    body: {
      item1: {
      ...
      item2: {
        title: 'Make an investment of $1000 or more',
        description: 'Choose a term and deposit funds via bank transfer.',
        bonusRate: '2.5',
      },
      item3: {
        title: 'Refer up to 15 friends',
        description:
          'Get your friends involved, and get rewarded for each friend you bring on board.',
        additionalDesc: 'Your referral link: ',
        bonusRate: '3',
      },
    },
    ...
    faqs: {
      ...
      content: {
        ...
        faq2: {
          question: 'How do I earn reward interest?',
          answer: `
          <p>
        ...
        faq3: {
          question:
            'Is there a limit on the amount of extra interest I can earn?',
          answer: `
          <p>
        ...
        faq5: {
          question: 'When will I receive the extra interest?',
          answer: `
          <p>
        ...
        faq6: {
          question: 'Will the interest expire?',
          answer: `
          <p>
  ...
  faqs: {
    ...
    collateral: {
      question1: 'What assets do you accept as collateral?',
      answer1: `
        <p>We only accept bitcoin and ethereum at the moment.</p>
      `,
      question2:
        'What happens if my collateral falls in value during my loan term?',
      answer2: `
    ...
    repayment: {
      question1: 'How do I repay my loan?',
      answer1: `
      ...
      `,
      question2: 'What happens if I can’t repay the loan?',
      answer2: `
        <p>We’ll sell your collateral. That’s it.</p>
      `,
      question3: 'Can I repay the loan in another currency?',
      answer3: `
      ...
      `,
      question4: 'Can I repay the loan in cryptocurrency?',
      answer4: `
      ...
      `,
      question5: 'How long do I have to repay once the loan term is over?',
      answer5: `
    ...
    interest: {
      question1: 'What is the interest rate?',
      answer1: `
      ...
      `,
      question2: 'Why is the interest rate so low?',
      answer2: `
    ...
    cryptoLoanTech: {
      question1: 'How do Crypto Loans work?',
      answer1: `
    ...
    tech: {
      question1: 'Why do you digitize my investment?',
      answer1: `
      ...
      `,
      question2: 'How does digitization work?',
      answer2: `
    ...
    withdraw: {
      ...
      `,
      question2: 'In which currencies can I withdraw?',
      answer2: `
      ...
      `,
      question3: 'Do you charge withdrawal fees?',
      answer3: `
        <p>
      ...
      `,
      question4: 'Is there a limit on the number of withdrawals I can make?',
      answer4: '<p>No, you can withdraw as much and as often as you like.</p>',
      question5: 'How long do withdrawals take?',
      answer5:
        '<p>If you’re based in the US, your funds should arrive the same day as you request the withdrawal. If you’re based outside of the US, it might take a day or two, depending on your bank and country of residence.</p>',
    },
    deposit: {
      question1: 'Are my deposits safe?',
      answer1: `
      ...
      `,
      question2: 'Is there a limit to how much I can deposit?',
      answer2: `
      ...
      `,
      question3: 'How do I make a deposit?',
      answer3: `
      ...
      `,
      question4: 'Which currencies do you accept?',
      answer4: `
      ...
      `,
      question5: 'Do you accept cryptocurrencies?',
      answer5: `
      ...
      `,
      question6: 'Is there a limit on the number of deposits I can make?',
      answer6:
        '<p>No. You can deposit as much as you like, as often as you like.</p>',
    },
    transfer: {
      question1: 'How long will my transfer take?',
      answer1:
        '<p>It should be immediate, though at times of heavy network congestion, perhaps up to 30 seconds.</p>',
      question2: 'How much does a transfer cost?',
      answer2: '<p>Nothing. Constant transfers are free for everyone.</p>',
      question3: 'To which countries can I transfer money?',
      answer3: '<p>You can send funds to anyone, anywhere, anytime.</p>',
      question4: 'How do transfers work?',
      answer4: `
      ...
      answer6:
        '<p>To receive funds, your recipient needs either a Constant account or a web wallet that supports ERC-20 tokens. That way they can either receive USD or our USD-backed stablecoin, both of which can be withdrawn as USD or local currency (if the recipient doesn’t have a USD bank account).</p>',
    },
    account: {
      question1: 'Can I open a Constant account in my country?',
      answer1:
        'Anyone can open a Constant account, no matter where you live. All you need is an internet connection.',
      question2: 'How do I open a Constant account?',
      answer2:
        'Simply register with an email address and password to get started. To withdraw returns from your free $1,000 initial investment, you’ll need to verify your ID, which shouldn’t take more than a few minutes.',
      question3: 'What is the minimum capital?',
      answer3:
        'You can invest any amount you want. Better yet, once you’ve opened your account, we’ll give you a free initial investment of $1,000 so you can start earning investment income immediately. The $1,000 principal is returned to us at the end of your term (sorry!), but you keep the ROI. Not bad, right?',
      question4: 'Do you need to verify my identity?',
      answer4:
        'You can open a Constant account without verifying your identity. However, to withdraw earned investment income on your $1,000 initial investment (or any other investment amount), we will need to verify your identity. We do this to protect you from fraud and to comply with financial regulations.',
      question5: 'How do I reset my password?',
      answer5:
        'Go to the Login page and click “Forgotten your password?”. Then enter your email address and we will send you instructions on how to reset your password. If you can’t see our email after a few minutes, please check your spam/junk folder.',
      question6: 'Do I need to connect my bank account / bank info?',
      answer6:
        'You don\'t need a bank account to use Constant. However, if you withdraw your Constant investment income to USD (or local equivalent), you will need to enter the receiving bank account details. For additional security, we don\'t store this information for future transactions.',
    },
    initialInvestment: {
      question1: 'Is the initial investment promotion still available?',
      answer1:
        'Yes, the initial investment promotion is available until further notice. We’ll keep it going for as long as we can.',
      question2: 'Am I eligible for this promotion?',
      answer2:
        'As long as you’re a new customer and haven’t accepted an initial trial investment before, you are eligible.',
      question3: 'Can I withdraw the $1,000?',
      answer3:
        'While we’d love to give you $1,000, we can’t. The $1,000 will be returned to us at the end of your commitment period, but you keep the returns, which is still a pretty good deal.',
      question4: 'How can I track the returns from this promotion?',
      answer4:
        'Just log into your account and click Your Investments. Total earned investment income is on the top right of the dashboard.',
      question5: 'What happens at the end of my commitment period?',
      answer5:
        'At the end of the term, we’ll pay you the total profit (assuming you haven’t withdrawn it already) and the $1,000 principal will be returned to us. Please note that we will need to verify your identity before you can withdraw investment income to your bank account. This protects you from fraud and complies with financial regulations.',
      question6: 'Can I invest more in the initial investment promotion?',
      answer6:
        'No, but you can invest in other Investment Plans whenever you like.',
      question7:
        'Can I choose different commitment periods for other Investment Plans?',
      answer7:
        'Absolutely! Participation in the initial investment promotion is separate from your other Investment Plans, so you can choose the amounts and terms for your other investments.',
    },
    invest: {
      question1: 'What is a Constant Investment Plan?',
      answer1:
        'Our Investment Plans are simple, low-risk, and effective ways to grow your money. You choose a commitment period, invest your money, and at the end of the period you get your money back plus earned investment income. It really is as simple as that.',
      ...
      `,
      question3: 'How do you protect my investment?',
      answer3:
        'Your principal is securely held in the Constant Vault, which is overseen by an accredited US financial institution called Prime Trust. Your investment is FDIC-insured to $250,000. You can read more about the Constant Vault on <a href="https://medium.com/@constantmoney" target="_blank">our blog</a>',
      question4: 'Which currencies do you accept?',
      answer4:
        'We accept any currency sent to our US-based Constant Vault bank account. It is then converted to USD and stored in the FDIC-insured Vault.',
      question5: 'Do you accept cryptocurrency?',
      answer5: 'Not at this time.',
      question6: 'Can I access my principal investment at any time?',
      answer6: `
      ...
      `,
      question7: 'Where is my investment stored?',
      answer7: `
      ...
      `,
      question8: 'Can I add to my Investment Plan during the term?',
      answer8: `
      ...
      answer9:
        'The Constant Vault is a publicly-audited trust overseen and managed by Prime Trust, a US accredited financial institution. The Constant Vault is regulated in the US and insured by the FDIC to the value of $130,000,000 (a per account limit of $5,000,000 applies).',
      question10: 'What is FDIC insurance?',
      answer10: `
      ...
      `,
      question11: 'Why do you lend my savings to borrowers?',
      answer11: `<p>
      ...
      question12: 'Is there a minimum or maximum amount I can save?',
      answer12: `
        <p>No. You can save as much or as little as you like.</p>
      `,
    },
    returns: {
      question1: 'How are my returns paid out?',
      answer1:
      ...
      question4: 'Will you increase ROI rates in the future?',
      answer4: `
        <p>You never know ;-)</p>
        <br />
      ...
      `,
      question5: 'How can you offer such high returns risk-free?',
      answer5: `
    ...
    general: {
      ...
      answer3:
        'Yes. Your investments are held securely in our trust, which is regulated under US law. That’s why we ask you to verify your identity when you withdraw investments to your bank account.',
      question4: 'How does Constant make money?',
      answer4:
        'We charge interest on collateralized loans to pay you investment income, and make a very slim profit from the difference.',
      question5: 'Who are the people behind Constant?',
      answer5:
        'We’re a diverse team of engineers, economists, monetary policymakers, and industry experts. You can read all about our team on <a href="/about-us" target="_blank">About Us</a>.',
      question6: 'Where is Constant based?',
      answer6:
        'Everywhere! We are a registered US entity supported by a global team with presences in the USA, Vietnam, and Malta. If you’re in our neighborhood, drop by anytime.',
    },
  },
  statistics: {
    s0: 'Users',
  ...
  exchangeInputDepositForm: {
    ...
    minVndRequired: 'Please enter an amount larger than 10,000 VND',
    fiatAmountInputLabel: 'Deposit amount',
    currencyDropdownLabel: 'Your currency',
    amountResultLabel: 'According to the markets today, that is:',
    submitBtn: {
    ...
    amountTooSmall: 'Your amount is too small, please try a larger amount',
    ...
    loading: 'Loading...',
    amountMustBeLargerThan:
      'Your amount must be larger than {min} {fiatCurrency}',
  ...
  exchangeInputSellForm: {
    amountResult: {
      amountToWithdraw: 'Amount to withdraw: {amount} {currency}',
      fee: 'Withdrawal fee: {fee} {currency}',
      withdrawFee: 'Withdrawal fee: {fee} {currency}',
      sendFee: 'Send fee: {fee} {currency}',
      fiatAmountResultLabel:
        'According to the markets today, you’ll receive: {fiatAmount} {fiatCurrency}',
      explain:
        '* The maximum you can withdraw is {amountExcludeFee} {currency}, so you have enough to cover the withdrawal fee.',
      explainNoFee: '* The maximum you can withdraw is {amountExcludeFee} {currency}.',
    },
    ...
    getFeeFailed: 'Failed while calculating fee, please try again',
    getCurrencyListFailed: 'Failed while getting supported currencies',
    howMuchDoYouWantToSend: 'How much do you want to send?',
    howMuchDoYouWantToWithdraw: 'How much do you want to withdraw?',
    yourAnytimeBalance: 'Your Anytime Balance: {balance} {currency}',
    whichCurrencyYouWant: 'Which currency do you want to receive?',
    recipientBankInformation: 'Recipient’s bank information',
    toABankAccount: 'To a bank account',
  ...
  exchangeInputBuyTrialForm: {
    title:
      '<h6>We’re giving you a 1000 USD free initial investment. Just so you can see how it works. At the end of the trial, you keep all the returns.</h6>',
    highlightText: 'you keep all the interest.',
    trialLeft: '{number} trials left.',
    noMoreTrialLeft: 'No more trial left.',
    submitBtn: 'INVEST NOW',
    btnDesc:
      'New customers only. This 1000 USD trial deposit will be returned at the end of your chosen term, but you keep all the interest.',
    termLabel: 'Pick your investment option',
  },
  termSelector: {
    label: 'Choose a commitment period.',
    month: 'months',
    rate: '{rate}%',
    apr: 'Annual Return',
    amountText: '({amount} {currency})',
    anytimeTerm: 'anytime',
    oneMonthTerm: '1 month',
    term: '{term} months',
    fiatAmountText: '{fiatAmount} {fiatCurrency}',
    desc: 'Your returns are guaranteed at: {interestAmountText} after 1 year.',
    desc1: 'Your returns are guaranteed at: {interestAmountText} after {time}.',
    desc2: 'The 1000 USD principal expires, but the profit is yours to keep.',
    desc3: 'That means you\'ll earn: {withdrawAmount} after {time} ! Nice work.',
    desc4: 'Earn 1% on your existing balance, and withdraw anytime.',
    trialExpires:
      'The 1000 USD principal expires, but the profit is yours to keep.',
    item: {
      termTitle: '{month}-Month{termType}',
      // zero: {
      //   name: 'Anytime',
  ...
  saving: {
    trialLeftNum: 'ONLY {trialLeft} TRIALS LEFT',
    title: '<h1><span>Invest</span> the way you want.</h1>',
    subTitle:
  ...
  send: {
    ...
    what: {
      whatCaption0: '0.25%',
      whatCaption1: 'Convenient',
      whatCaption2: 'Reliable',
      whatCaption3: 'We’re here to help',
      whatDesc0:
        '<p>We only charge 0.25% for withdrawing to a local bank. For amounts of $14,000 and above, fees are capped at $35, never more.</p>',
      whatDesc1:
        '<p>No waiting in line or waiting for business hours - all you need is an internet connection. Simply enter the amount and where you want to send it to.</p>',
      whatDesc2:
        '<p>All funds you send are FDIC insured up to $130M, and once a transfer is made, it’s unstoppable. That’s how we protect your money, and make sure it gets to where it needs to go.</p>',
      whatDesc3:
        '<p>Our team is based in your preferred time zone. If you’re in the US, call us at 1-844-201-7242. If you’re in Vietnam, call us at +84 36 656 2949.</p>',
    },
    howItWorks: {
      title: 'How to send',
      step1: 'Step 1',
      title1: 'Sign up',
      desc1:
        'All you need is an email address. You can also sign up using a facebook or google account.',
      step2: 'Step 2',
      title2: 'Make a deposit',
      desc2: 'Make a bank transfer to the FDIC-insured Constant Vault.',
      step3: 'Step 3',
      title3: 'Send money',
      desc3:
        'Enter the amount you’d like to send and the recipient\'s bank account info. We take care of the rest.',
    },
  },
  withdraw: {
    makeLocalOrderSuccess: 'Your order was created successfully',
    ...
    what: {
      ...
      whatCaption3: 'Unlimited low-cost withdrawals',
      whatDesc0:
        '<p>Easily transfer Constant funds to your local bank account. Just let us know where to send it.</p>',
      whatDesc1:
        '<p>Funds should reach you within 2 days, but times may vary depending on your bank’s operating hours.</p>',
      whatDesc2:
        '<p>Your money is stored in USD. If you withdraw in a different currency, it will be converted at the current market rate.</p>',
      whatDesc3:
        '<p>Withdraw as often as you like. The only fee we charge is a 0.25% withdrawal fee - capped at $35. Never more.</p>',
    },
    howItWorks: {
      step1: 'Step 1',
      title1: 'Sign up',
  ...
  deposit: {
    ...
    availableInVn: 'Available now in Vietnam.',
    subTitle: {
      sub1:
        'Save in US dollars, instead of unstable local currencies. Enjoy instant transfers of any amount - to anyone or any business - anywhere in the world. For free.',
      sub2:
        'Your account is backed by the full faith and credit of the United States government, insured by the Federal Deposit Insurance Corporation (FDIC). Established in 1933, the FDIC has a perfect record of no lost funds.  {learnMore}',
      learnMore: 'Learn more +',
    },
    what: {
      ...
      whatCaption3: 'Withdraw your money anytime',
      whatDesc0:
        '<p>Save in USD, the world reserve currency, accepted by merchants worldwide. Protect your money against inflation and instability.</p>',
      whatDesc1:
        '<p>Send and receive any amount, anywhere in the world, instantly and for free. Do bigger business, send money home, unlock greater mobility.</p>',
      whatDesc2:
        '<p>Benefit from the maximum coverage the FDIC provides - multiplied by 20. Since the FDIC insures each account up to $250K, we store your money across 20 of them.</p>',
      whatDesc3:
        '<p>Constant works with your local banking system to make sure that all your funds can be withdrawn anytime, in your currency of choice.</p>',
    },
    howItWorks: {
      title: 'How it works',
      step1: 'STEP 1',
      title1: 'YOU MAKE A DEPOSIT',
      desc1:
        'Send any currency to your local Constant Trust. If it’s not USD, we convert it.',
      step2: 'STEP 2',
      title2: 'WE PROTECT YOUR MONEY',
      desc2:
        'Your USD funds are held safely in fully insured US bank accounts.',
      step3: 'STEP 3',
      title3: 'YOU GET MORE',
      desc3:
        'Now you have a global USD account with free transfers and unlimited withdrawals.\n',
    },
    checklist: {
      title: 'Why you should save money with Constant.',
      subTitle: 'Smarter than your average bank.',
      desc1:
        'Like traditional banks, we reward you with interest earnings on our collateralized loans. Unlike traditional banks, <b>we give you most of it - since it’s your money, really.</b>',
      desc2:
        'And because we replaced cashiers with code, advisors with algorithms, and switched out bricks and mortar for the blockchain - <b>we can pass the savings directly on to you.</b>',
    },
    howWeWork: {
      title: 'How We Work',
      subTitle: 'We’re building a fairer, freer, financial system.',
      desc: `
    ...
    stories: {
      quote0:
        'Great user experience. It\'s always fun watching my savings grow, and super convenient that I can withdraw it anytime. A nice zero-risk companion to your other investments, and a decent enough investment in itself.',
      author0: 'Carlos',
      title0: 'Father of three, saving for a rainy day',
      quote1:
        'Love that there\'s no minimum deposit required so anyone can benefit from their rates. Feel much safer (and smarter) keeping the tips I make with Constant instead of in a box under my bed!',
      author1: 'Kate',
      title1: 'Student, being smarter with her money',
      quote2:
        'I used to save USD in my local bank account in Vietnam and earn no interest.  Now I can save and grow my money in USD, in an account fully protected by the FDIC, which I didn\'t think was possible for foreigners like me.',
      author2: 'Binh',
      title2: 'Business owner, looking for a more stable currency.',
      quote3:
        'The \'fringe\' benefits are the best part - my friends and business partners in different countries can all get accounts easily, and you can transfer money between them for free. It\'s actually much more than just saving.',
      author3: 'Veronica',
      title3: 'Freelancer, citizen of the world',
    },
    intro: {
      desc: {
  ...
  newHome: {
    banner: {
      ...
      intro: {
        youtube: {
          title: 'Fully Secured Peer To Peer Lending - How It Works'
        }
      }
    },
    crypto: {
    ...
    howItWorks: {
      ...
      content: {
        0: {
          title: 'Investors', desc: 'Investors deposit any amount and choose either crypto-backed or Loan Originator lending.',
        },
        1: {
          title: 'Crypto-collateralized borrowers', desc: 'Borrowers must put up 100-200% of the loan amount in cryptocurrency to secure their loan.'
        },
        2: {
          title: 'Buy-back guaranteed borrowers', desc: 'Loan originators guarantee to buy back loans if they default longer than 60 days, protecting investor funds.'
        },
        3: {
          title: 'Loan origination partners', desc: 'We work with trusted, vetted loan originators to connect you with more borrowers and better returns.'
        },
        4: {
          title: 'Custodial partner', desc: 'We use Prime Trust to safely manage the transfer and storage of investor funds and borrower collateral.'
        }
      }
    },
    whyItBetter: {
  ...
  support: {
    title: 'Monday to Friday, 9am - 5pm PT',
    text: 'Call us at {phone}. Monday to Friday, 9am - 5pm PT.',
    newTitle: `
  ...
  ours: {
    ...
    team: {
      ...
      content:
        'We’re proud of our extraordinary team of more than 50 scientists, engineers, designers, writers, economists, and customer experience specialists from all over the world — fully devoted to our mission of building simple, elegant, useful tools to suit the needs of our global village.',
      ...
      captions: {
        0: {
          ...
          link:
            'https://medium.com/@constantbanking/meet-trong-the-man-putting-the-smart-in-smart-contract-b4345a31726c',
        },
        1: {
    ...
    leaderships: {
      ...
      leaders: {
        ...
        tienNguyen: {
          ...
          description:
            '<p>Tien has built some of this decade’s most important products.  He built mobile payments for emerging markets at Google and payment hardware and software solutions for SMB businesses at Square.  Tien also built the Android app at Uber.  He is currently leading app development at Essential.</p>',
        },
        gaelVo: {
          name: 'Gaël Vo',
  ...
  home1: {
    lendingSection: {
      intro: {
        ...
        youtube: {
          title: 'Why invest with Constant?',
        }
      },
      form: {
        ...
        btnTrial: 'Start your free trial',
        btnAuth: 'Log in or Register to invest',
        btnKyc: 'Verify your ID to invest',
        btnKyc1: '<a>Verify your ID</a> to invest',
        minRate: 'Your minimum interest rate',
        maxRate: 'Your maximum interest rate',
      ...
      alert: {
        success: 'Success',
        sendEmailVerifyForTrialSuccess:
          'Thanks! We sent you a verification email to unlock your free trial.',
        sendEmailVerifyForTrialFailed:
  ...
  landingProReferral: {
    ...
    inviteEmail: {
      ...
      placeholder: 'Enter email address, seperate by commas',
      btn: 'Invite',
      sendInvitationsSuccess: 'Send Invitations Successfully!',
  ...
  getPrices: {
    ...
    earlyRepayment: {
      head1: 'Early Repayment',
      head2: 'Fees',
    },
    lateRepayment: {
      head1: 'Late Repayment',
      head2: 'Fees',
    }
  },
  modules: {
  ...
  proLending: {
    ...
    matchedOrders: {
      ...
      titleDesc: 'These are orders matched. To view more your matched orders, [please visit your accounts page].',
      invest: 'invest',
      borrow: 'borrow',
      side: 'Side',
      amount: 'Amount(USD)',
    ...
    investBooking: {
      messLoginFirst: {
        invest: 'You must be login before make an investment!',
        borrow: 'You must be login before make an borrow!'
      },
      messDepositFirst: 'your account balance was not enough. You must be deposit before make an investment!',
      ...
      deposit: {
        ...
        depositNote: 'If you don\'t want to miss  invest opportunity, please make sure to keep your funds sufficient.',
      },
      form: {
        title: 'Invest',
        amount: 'Amount (USD)',
  ...
  yourReferral: {
    ...
    info: {
      ...
      title: 'Get your friend involved',
      desc: `
      ...
      `,
      buttonRedeem: 'Redeem STAR',
      buttonWithdraw:'Withdraw STAR',
      buttonTransfer: 'Transfer STAR',
      buttonReceive: 'Receive STAR',
    ...
    withdraw: {
      amountPlaceholder: 'Please enter your amount here',
      amount: 'Amount',
      address: 'STAR Address',
      addressPlaceholder: 'Please enter your address here',
      successMsg: 'Success! You withdraw STAR.',
      failedMsg: 'Something went wrong! Please try again',
    },
    transfer: {
      email: 'Email',
      emailPlaceholder: 'Please enter your email here',
      successMsg: 'Success! You transferred STAR.',
      failedMsg: 'Something went wrong! Please try again',
    ...
    flex: {
      ...
      `,
      buttonRefer: 'Refer friends',
      buttonFriendEarn:'Friends earn interest',
      buttonYouEarn: 'You earn 10%',
      stepRefer: 'STEP 1',
      stepFriendEarn:'STEP 2',
      stepYouEarn: 'STEP 3',
    }
  },
  registerBonus: {
  ...
  borrowHeader: {
    desc: 'Get cash or stablecoins for a $50 Thanksgiving reward',
    action: 'Borrow now',
    ruleDesc: 'New customers only. Promotion starts 00:00 GMT 11/21/19 and ends 23:59 GMT 11/28/19. Available rewards: $10 (minimum loan $1,000), $20 (minimum loan $2,000), and $50 (minimum loan $5,000). Minimums apply to single loans only'
  },
  menuMobile: {
    btnSignIn: 'Sign in',
    account: 'Account',
  ...
  staking: {
    ...
    howMuchDoYouWantToDeposit: 'How much do you want to staking?',
    ...
    depositNow: 'Start staking?',
    depositWithAmount: 'Start staking {amount} {currency}',
    validateMinAmountError: 'You can\'t input amount less than {amount} {currency}',
    ...
    withdrawFrom: {
      unStaking: {
        title: 'Un-staking',
        amount: 'Amount',
        amountDesc: 'How much do you want to un-taking?',
        usingAvailableBalance: 'Use max available amount ({maxAmount} {currency})?',
        address: 'Your {name} wallet address?',
        addressDesc: 'Receiving crypto wallet address',
        maxAmount: 'Your amount must be less than {maxAmount} {symbol}.',
        withdrawFailed: 'Something went wrong. Please try again.',
    ...
    confirmation: {
      ...
      cryptoThankMsg: 'Simply transfer {amount} {currency} to the wallet address below to begin staking.',
      ...
      minuteWindow: 'Please complete your transfer within 24 hours.',
      scanQR: 'Alternatively, scan this QR code directly from your mobile wallet to complete the staking.',
      backOrderBook: 'Back'
    },
    learnMore: 'For more information, ',
    learnMoreFAQs: 'check out our FAQs.',
    faqs: {
      1: {
        question: 'What is a masternode?',
      ...
      2: {
        question: 'What is a masternode pool?',
      ...
      testimonials: {
        ...
        articles: {
          ...
          6: {
            ...
            link: 'https://blog.myconstant.com/invested-tusd-with-constant',
            date: 'Jun 27, 2019',
            author: 'Constant'
          },
        }
  ...
  history: {
    support: {
      ...
      invalidPhotoSize: 'Files supported: jpg, png. Max file size: 4 MB.',
      confirm: 'Send',
      cancel: 'No'
    },
    deposit: {
    ...
    invest: {
      title: 'History',
      noHistoryData: 'Make an investment to get started.',
      tabs: {
        plus: '+',
        minus: '-',
        interest: 'Interest',
...
`,
    ...
    loanOriginator: {
      headers: {
        ...
        financialPublicationDate_desc: 'The date the loan originator publishes its financial statements on the Constant marketplace.',
    ...
    loanDisbursementDetail: {
      title: 'Assignment Transaction Record',
      export: 'Export',
