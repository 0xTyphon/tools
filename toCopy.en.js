export default {
  ...
  memberShip: {
    ...
    faqs: {
      ...
      '9': {
        ...
        answer: '          <p>          Interest from referrals is exclusive to each level of membership. The instant credit reward can each be earned only one time per each level. For example, if you invest $100,000, you’ll get $150 + 1 STAR + 20% of earned interest from referred friends’ Flex accounts (until your membership points expire).           </p>          '
      },
      '10': {
    ...
    desc: {
      level1: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> ${cashback} credit to your Constant account the first time you reach Gold (after leaving a review on Trustpilot).</p>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Flex accounts of referred friends during their first year.</p>            ',
      level2: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> ${cashback} credit to your Constant account the first time you reach Platinum (after leaving a review on Trustpilot).</p>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Flex accounts of referred friends during their first year.</p>            ',
      level3: '<h4>What you get:</h4>              <p><i class="fal fa-check"></i> ${cashback} credit to your Constant account the first time you reach Diamond (after leaving a review on Trustpilot).</p>              <p><i class="fal fa-check"></i> US members: ${referralReward} credit every time you refer a friend.</p>              <p><i class="fal fa-check"></i> {referralFlexReward}% of all earned interest from Flex accounts of referred friends during their first year.</p>              <p><i class="fal fa-check"></i> Automatic bump to the top of our matching queue for all investments.</p>              <p><i class="fal fa-check"></i> {bonus} STAR token to redeem for a {bonus}% bonus or discounted interest.</p>            '
    },
  ...
  me: {
    ...
    proSaving: {
      listApplications: {
        ...
        balanceStarDesc: '        A STAR is a reward token you can redeem for 1% bonus interest on an investment or a 1% discount on a loan. Earn STAR every time you reach Diamond membership (invest or borrow $100,000 in 180 days).        ',
        ...
        noLoans: 'Request your first fixed rate loan here.',
    ...
    flexInterestConfig: {
      ...
      enableFlex: {
        ...
        cancel: { title: 'No' },
        enableFlexSuccess: {
          true: '<p>Your balance will be escrowed with Prime Trust, an accredited US financial institution. Prime Trust stores your funds across multiple insured bank accounts, giving total coverage of $130,000,000. You can withdraw anytime for free, but your balance will not earn interest.</p><a href="https://blog.myconstant.com/meet-scott-purcell-—-ceo-of-prime-trust" class="underline" target="_blank">Find out more about Prime Trust</a>',
  ...
  headerBar: {
    ...
    extraMenuMobile: {
      ...
      investCustom: {
        title: 'Crypto-backed',
        desc: 'Your terms. Best rates. Backed by crypto.'
      },
      investFlexCrypto: {
        title: 'Crypto Lend',
  ...
  newHome: {
    crypto: {
      desc: 'All lending includes either cryptocurrency collateral or the loan originator’s buy-back guarantee to protect your investment against borrower defaults.'
    },
    whyItBetter: {
    ...
    banner: {
      ...
      loanOriginator: {
        title: '          <p>            <strong>INVEST <sup>NEW</sup></strong>            Loan Originator          </p>        ',
  ...
  home: {
    constantLoan: {
      ...
      what: {
        ...
        whatDesc2: '          <p>Smart contracts and Prime Trust custody protect your collateral while ensuring we can return it to you as quickly as possible.</p>        ',
        whatCaption3: 'No credit scoring',
        whatDesc3: '          <p>No credit scoring or background checks. Get funds instantly, no month-long waiting games for approval.</p>        '
      },
      howItWorks: {
        title: 'How it works',
      ...
      faqs: {
        ...
        answer1: '        <p>As soon as we receive your collateral, we’ll deposit your loan into your Constant account. You can withdraw your loan as fiat to your bank account or as a stablecoin to your wallet address. All withdrawals are free.</p>        <p><a href="https://blog.myconstant.com/how-to-borrow-against-crypto-4-simple-steps" className="underline" target="_blank">How to borrow in 4 simple steps.</a></p>      ',
        question2: 'Do you check my credit score?',
        answer2: '        <p>As we only offer secured loans backed by collateral, there is no need for credit scoring. All you need is adequate collateral to secure your loan. To see how much collateral you need to secure your loan, simply enter the amount you’d like to borrow. The calculator will work out the amount for you.</p>        <p><a href="https://blog.myconstant.com/how-to-borrow-against-crypto-4-simple-steps" className="underline" target="_blank">How to borrow in 4 simple steps.</a></p>      ',
        question3: 'How do you protect my collateral?',
        answer3: '        <p>Depending on your collateral, it’s either held safely in Prime Trust custody, an Ethereum smart contract, or a password-protected web wallet hosted on a dedicated server (to which only our CEO and CTO have access). When you repay, your collateral is immediately transferred back to you.</p>        <p><a href="https://blog.myconstant.com/how-we-protect-your-money-and-collateral" className="underline" target="_blank">How we protect your collateral.</a></p>      ',
        ...
        answer5: '        <p>We will notify you three times at 5% intervals before your collateral falls to 110% of the loan value + interest to date. At that point, we’ll create a sell order to repay the investor. You keep the loan, but you lose your collateral.</p>        <p>Borrowers will receive notifications at 125%, 120% and 115% of the investor’s principal plus earned interest. You can choose to repay early to avoid liquidation or top up more collateral. In the event of a flash crash, collateral will be automatically liquidated at 110%.</p>        <p>If you’re borrowing against stablecoins, you will be notified at 115%, 110%, and finally 105%. Once your collateral falls to 100% of the loan amount it will be sold to repay the investor.</p>        <p><a href="https://blog.myconstant.com/extra-protection-for-your-collateral-auto-top-up" className="underline" target="_blank">How to avoid liquidation with auto top-up.</a></p>      ',
        question6: 'Can I repay early?',
        answer6: "          <p>If you'd like to pay back your loan before 75% of the term is up, that's absolutely fine. You simply have to pay interest for the days you are in possession of the loan, and just 50% of the original interest rate for the remaining days of the term.</p>          <p>If you'd like to pay back your loan after 75% of the term is up and claim back your collateral, that's also fine, but the interest due on that loan is the full percentage for the entire term.</p>        ",
        ...
        answer9: '          <p>We’ll deduct your repayment directly from your Constant account balance. Adding funds is easy. You can do one or a combination of the following:</p>          <ol>            <li>Transfer USD to one of our US bank accounts.</li>            <li>Send any one of our supported stablecoins: USDT/USDC/TUSD/GUSD/PAX/USDS.</li>            <li>Repay the equivalent USD value using your collateral.</li>          </ol>          <p>Your balance will update when funds have been received in your Constant account.</p>        ',
        ...
        answer12: '        <p>        Nope! You must still repay each loan individually. However, crypto selected for collateral repayments will still follow a 24-hour trading volume priority based on what you have available.        </p>        ',
        question13: 'I can’t find where to choose multiple collaterals for my borrow order',
        answer13: '        <p>        If you take out a crypto-backed loan or buy new cryptos using Crypto Credit, you’ll only see the option to use one collateral. To borrow with multiple collaterals you must start on <a href="https://www.myconstant.com/pro-lending" target="_blank" class="underline">our pro page.</a>        </p>        ',
        question14: 'Why do you prioritize collaterals based on 24-hour exchange volume?',
        answer14: '        <p>        Loan security is our top priority on Constant. In the unfortunate case of liquidation, we always want to make sure we can sell collateral as fast as possible to cover the loan value.        </p>        ',
        ...
        answer16: '        <p>        No. You can only toggle auto top-up on or off for all multi-collateral loans at the same time. However, you can choose this setting separately for each isolated (single-collateral) loan.        </p>        ',
        ...
        answer18: '        <p>        Right now you still must pay off all of your loans individually.        </p>        ',
        question19: 'If I have multiple active loans, which collaterals do I get back when I repay my earliest loans?',
        answer19: '        <p>        If you still have active loans after repaying, your collateral won’t be released back to your available balance. Instead, it will go into your collateral balance for multi-collateral. If you want to remove collateral from this balance, you’ll need to recall excess from the overview screen and choose the crypto type and amount you want.        </p>        ',
        question20: 'I can’t recall excess on my crypto even though my collateral value is over 110%.',
        answer20: '        <p>        Collateral value is only used to determine loan liquidation. It is calculated by:        </p>        <p class="font-italic">        (number of coins * value)+”repeat for each coin”/(loan value + up-to-date interest + matching fee)        </p>        <p>        We calculate how much collateral you withdraw through recall excess based on the collateral rate. For more information on the collateral rate see below.        </p>        ',
        question21: 'What is the collateral rate and why is it different from the collateral value?',
        answer21: '        <p>        Collateral value only takes into account the monetary value of your collateral in your collateral balance compared to your loan amount. We base liquidation off collateral value. Your collateral rate is a more in-depth number that takes into account the LTV ratios required for different cryptocurrencies. We use this number to determine how much you can withdraw with recall excess as well as the maximum amount of crypto you can place in an Isolated loan.        </p>        <p>        You can find your collateral rate through this equation:        </p>        <p class="font-italic">        x = (number of coins)*(coin value)*(LTV)+“repeat for each coin”<br />        Collateral rate = (x/(loan value at first + up-to-date interest + matching fees))*100        </p>        '
      },
    ...
    constantC2CLoan: {
      cryptosDesc: 'Your collateral is securely stored in either a Prime Trust cold wallet, an Ethereum smart contract, or a password-protected web wallet until you repay your loan.',
      intro: {
        content: '        <p>Fast and easy crypto credit</p>        <h1>Trade the margin.</h1>        <p class="h1">Skip the exchange.</p>        <p class="h1">Borrow against 60+ cryptos.</p>        <p/>        <p>Borrow cash against your crypto to buy new coins. You set the rate and term, we match you with an investor, and then deposit your chosen coin. No exchanges. No trading fees. Best rates.</p>        <p>Now you can pool your buying power with multi-collateral loans! Check out <a href="https://blog.myconstant.com/multi-crypto-loans" target="_blank" class="underline">our blog</a> and FAQs for more details.</p>      ',
      ...
      why: {
        ...
        whatDesc2: '          <p>Our pricing algorithm searches multiple exchanges to find you the best price, saving you time and money. We compare the market so you can focus on trading.</p>        ',
        whatCaption3: 'Guaranteed approval',
        whatDesc3: '          <p>Constant is for everyone. No credit scoring, background checks or month-long waiting games for approval.</p>        '
      },
      howItWorks: {
        title: 'How it works',
      ...
      faqs: {
        ...
        answer1: '        <p>Crypto Credit is a fast, easy way to borrow USD against your existing cryptocurrencies to buy new coins.It’s a bit like a margin account, only it’s faster, cheaper, and you always get the best price for your chosen cryptocurrency.</p>         <p>You choose the interest rate and term and put down collateral equivalent to the USD value of your chosen crypto. We then search multiple exchanges to find the best prices and then deposit your chosen crypto into your Constant coin balance.</p>         <p>Meanwhile, we store your collateral in a Prime Trust wallet insured to $100M. When you repay the USD loan, you get your collateral back. There are no trading fees, no withdrawal fees, and you always get the best price for your chosen cryptocurrency.</p>',
        question2: 'How does Crypto Credit work?',
        answer2: '        <p>First, decide which cryptocurrency you want to buy. </p>        <p>Then, set the details for your loan – including the collateral you want to use, the interest rate, and term.</p>         <p>You’ll then see how much USD you’re going to borrow. This is also the amount you’ll need to repay. We get prices from multiple exchanges to ensure you get the best deal.</p>         <p>If you have enough collateral in your coin balance, you can create your order. Otherwise you’ll need to top-up from your coin balance first. You won’t be able to create an order unless you have sufficient collateral in your coin balance.</p>         <p>When you match with an investor, we use their funds to buy your chosen cryptocurrency and then deposit it in your coin balance. You can then withdraw it to any wallet you like. You won’t interact with an exchange at all. </p>        <p>Then, just repay before the term ends to get your collateral back.</p>         <p>That’s it!</p>        ',
        question3: 'Why use Crypto Credit instead of an exchange?',
        answer3: '        <p>Exchange margin accounts charge higher interest rates, trading fees, withdrawal fees, and have only one source for pricing data: the exchange. </p>        <p>With Constant Crypto Credit, you set the rate and term to a level you’re comfortable with. Then, we search multiple exchanges to find you the best price, and faster, so you don’t ever miss out on better deals. All trading and withdrawals are free, too.</p>         <p>While with us, your collateral is held in a Prime Trust wallet insured to $100M. Most exchanges store collateral in uninsured hot wallets which are less secure and don’t cover you against theft.</p>         ',
        question4: 'Am I borrowing cryptocurrency or USD?',
        answer4: '        You borrow USD that we then use to buy your chosen cryptocurrency for you. We do the hard work on the exchanges so you can focus on your trading strategy.        ',
        question5: 'How do I repay a Crypto Credit loan?',
        answer5: '          <p>You can repay your loan in the following ways:</p>            <p>1) Deposit USD or a supported stablecoin. <br/>            2) Repay the equivalent USD value using your collateral.</p>         ',
        question6: 'How do you protect my collateral?',
        answer6: '          <p>Your collateral is stored in a Prime Trust wallet that’s insured to $100,000,000. This protects you against:</p>            <p> - Third-party hacks, copying, or theft of private keys.<br>             - Insider theft of dishonest acts by BitGo employees or executives.<br>             - Loss of keys.</p>          <p>When you repay, we co-sign the release of your collateral back into your coin balance and you can then withdraw it to any wallet address you choose.</p>          <a target="_blank" href="https://blog.myconstant.com/how-we-protect-your-money-and-collateral">How we protect your collateral.</a>        ',
        question7: 'How long will it take to match and get my cryptocurrency?',
        answer7: '        This depends on the rates and terms you set. Market rates will match you in thirty minutes, and you’ll match even faster if you set a higher rate. As we know timely settlement is important for margin traders, it might be worth paying more for a fast match.         ',
        question8: 'Do you check my credit score?',
        answer8: '          As we only offer secured loans backed by collateral, there is no need for credit scoring. All you need is adequate collateral to secure your loan. When creating your loan order, you’ll see how much collateral you need.         ',
        question9: 'What happens if I don’t repay the loan?',
        answer9: '          If you don’t repay the loan, your collateral will be sold to repay your investor. You get to keep your chosen cryptocurrency. That’s it.        ',
        question10: 'What happens if my crypto collateral falls in value?',
        answer10: '        <p>We will notify you three times at 5% intervals before your collateral falls to 110% of the loan value + interest to date. At that point, we’ll create a sell order to repay the investor. You keep your chosen cryptocurrency, but lose your collateral. </p>        <p>You receive email notifications at 125%, 120% and 115% of the investor’s principal plus earned interest. You can choose to repay early to avoid liquidation or top up more collateral. In the event of a flash crash, collateral will be automatically liquidated at 110%.</p>        <a target="_blank" href="https://blog.myconstant.com/extra-protection-for-your-collateral-auto-top-up">How to avoid liquidation with auto top-up.</a>         ',
        question11: 'Can I repay early?',
        answer11: "        <p>If you'd like to pay back your loan before 75% of the term is up, that's absolutely fine. You simply have to pay interest for the days you are in possession of the loan, and just 50% of the original interest rate for the remaining days of the term.</p>        <p>If you'd like to pay back your loan after 75% of the term is up and claim back your collateral, that's also fine, but the interest due on that loan is the full percentage for the entire term.</p>        ",
        question12: 'Can I recall excess if the value of my collateral increases?',
        answer12: '        <p>Yes. If the value of your collateral rises during your loan term, you can withdraw the difference from your Accounts page.</p>        <a target="_blank" href="https://blog.myconstant.com/how-to-deposit-top-up-recall-crypto-constant">How to deposit, top-up, and recall excess collateral.</a>        ',
        question13: 'What is the LTV (Loan-to-Value) Ratio? Is it always the same?',
        answer13: '        The LTV ratio varies according to the trading activity and liquidity of your chosen collateral. Most supported collateral has an LTV ratio of 66% for 9-month loans or shorter. That means we require 150% of the loan value in collateral. If you’re borrowing against stablecoins, the LTV ratio is 100% (you must put up 100% of the loan amount in stablecoins to obtain a loan).        ',
        question14: 'What happens if I repay late?',
        answer14: '        The grace period for receiving payment is 3 days after your term ends. On the 2nd and 3rd day, you will incur a late fee of 10% of the total interest due.        '
      },
      listApplications: {
        overview: 'Overview',
        mapStatus2: {
      ...
      headLine: 'Want to pay off your credit cards, medical bills or rent? Simply enter the amount of constant you want to borrow and make a deposit in ETH, which will be held securely in the Constant loan smart contact.',
      reference: '        <div name="ref-container">          <div name="ref-item">            <span name="ref-label">Interested rate:</span>            <span name="ref-value">{intRate}</span>          </div>          <div name="ref-item">            <span name="ref-label">Collateral value:</span>            <span name="ref-value">{colValue}</span>          </div>          <div name="ref-item">            <span name="ref-label">Collateral return:</span>            <span name="ref-value">{colReturn}</span>          </div>          <div name="ref-item">            <span name="ref-label">Default threshold:</span>            <span name="ref-value">{defThreshold}</span>          </div>        </div>      ',
      transaction: {
        title: 'Almost there.',
        message: 'To finalize your loan, please send your collateral to the following wallet address.',
        exchangeMaxAmount: 'Exchange Max Amount',
        ...
        summarizeContent: '          <div name="ref-container">            <div name="ref-item">              <span name="ref-label">Loan amount:</span>              <span name="ref-value">{loanAmount}</span>            </div>            <div name="ref-item">              <span name="ref-label">Interested rate:</span>              <span name="ref-value">{interestedRate}</span>            </div>            <div name="ref-item">              <span name="ref-label">Collaterals:</span>              <span name="ref-value">{collaterals}</span>            </div>            <div name="ref-item">              <span name="ref-label">Term:</span>              <span name="ref-value">{term}</span>            </div>          </div>        ',
        summarizeContent1: '          <div class="row">            <div class="col-md-6 col-sm-4">                <p class="semiBold">Loan amount:</p>            </div>            <div class="col">                <p>{loanAmount}</p>            </div>           </div>           <div class="row">            <div class="col-md-6 col-sm-4">                <p class="semiBold">Interested rate:</p>            </div>            <div class="col">                <p>{interestedRate}</p>            </div>           </div>           <div class="row">            <div class="col-md-6 col-sm-4">                <p class="semiBold">Collaterals:</p>            </div>            <div class="col">                <p>{collaterals}</p>            </div>           </div>        ',
        repaymentField: '            <div class="row">              <div class="col-md-6 col-sm-4">                  <p class="semiBold">Repayment date:</p>              </div>              <div class="col">                  <p>{repayment}</p>              </div>           </div>        ',
        borrowMore: 'Borrow more',
        termField: 'Term',
        termUnit: '{period} month',
        termUnit1: '{period} months',
      ...
      history: {
        itemTpl: '          <div name="loan-info-container">            <div name="loan-info-item">              <span name="loan-info-label">Loan amount:</span>              <span name="loan-info-value">{loanAmount}</span>            </div>            <div name="loan-info-item">              <span name="loan-info-label">Interest rate:</span>              <span name="loan-info-value">{interestedRate}</span>            </div>            <div name="loan-info-item">              <span name="loan-info-label">Collaterals:</span>              <span name="loan-info-value">{collaterals}</span>            </div>            <div name="loan-info-item">              <span name="loan-info-label">Term:</span>              <span name="loan-info-value">{term}</span>            </div>          </div>        ',
        address: 'Address',
        collateralAddress: 'Collateral Address',
        renew: 'Renew',
        status: {
        ...
        confirmPay: {
          payingInterest: {
            title: 'Interest Payment',
            content: '              <p>Your Interest payment is <strong>{amountConstant}</strong> Constant</p>              <p>Your collateral payment is <strong>{amountCollateral} {symbol}</strong></p>            ',
            success: 'Pay Successfully'
          },
          fullPayment: {
            title: 'Full Payment',
    ...
    loanOriginator: {
      listApplications: {
        ...
        dialog: {
          reInvestSetting: {
            messageConfirm: {
              true: '                <p>When your term ends, your interest and principal will return to your Constant account. You will then have to add more funds to invest in new loans.</p>                <p>Are you sure you want to disable auto-reinvest?</p>              ',
  ...
  support: {
    newTitle: `      <h6>Questions? Let's get on a call.</h6>      <h6>Set up a time <a href="http://calendly.com/justinconstant" target="_blank">here</a>.</h6>`
  },
  home1: {
    lendingSection: {
      form: {
      ...
      intro: {
        content: '          <p>Invest the way you want</p>          <h1>Earn up to 7.5% APR now.</h1>          <p class="h1">Start investing from just $50.</p>          <p class="h1">Experience crypto-backed P2P lending.</p>          <p />          <p>          Lend to cryptocurrency holders across the world for a return of up to 7.5% APR. You choose the term, we match you with a borrower, and you keep the interest. All lending is backed by collateral, which is sold if the borrower defaults.          </p>        ',
      ...
      confirm: {
        ...
        paymentMethods: {
          '0': {
            desc: '              <p>For direct deposits and wire transfers, we have accounts at major banks to receive your deposits faster. Please select the bank that is most convenient for you to transfer funds to.</p>              <p>If you don’t bank with any of those listed, no problem. You can transfer from any bank account, but please note that your bank might charge you a fee.</p>            ',
          ...
          '-2': {
            desc: '              <p>We’ve partnered with Checkbook to make bank transfers even easier.</p>              <p>Instead of logging into your bank account separately, enter your login details here and Checkbook will arrange the transfer automatically by ACH/digital check.</p>              <p>Neither Constant nor Checkbook store your details, and the service is free.</p>            ',
            referNoteDesc: ' '
          },
          '-3': {
            desc: '              <p>Google Pay is a fast, safe payment tool linked to your Google account. To get started, log into Google Pay and link a payment method (such as a bank card). Then enter the details on the right in your Google Pay account and click send.</p>            ',
            paymentInfo: '              <div class="row">                <div class="col">                    <label>Amount</label>                    <p>{amount} USD</p>                </div>                <div class="col">                    <label>Send to</label>                    <p>{email}</p>                </div>              </div>            ',
          ...
          '-4': {
            desc: '              <p>Venmo is a fast, easy, and convenient payment app from the makers of PayPal </p>              <p>To use Venmo, simply download the app and send your money to us using the details on the right-hand side of this page.</p>            ',
            paymentInfo: '              <div class="row">                <div class="col">                    <label>Amount</label>                    <p>{amount} USD</p>                </div>                <div class="col">                    <label>Send to</label>                    <p>{phone}</p>                </div>              </div>            ',
          ...
          '-5': {
            desc: '              <p>PayPal is one of the world’s most trusted and secure payment services. To get started, create a free PayPal account and link a card or bank account. Then enter the details on the right from your PayPal account and click send.</p>            ',
            paymentInfo: '              <div class="row">                <div class="col">                    <label>Amount</label>                    <p>{amount} USD</p>                </div>                <div class="col">                    <label>Send to</label>                    <p>{email}</p>                </div>              </div>              <div class="row">                <div class="col">                    <label>Full name</label>                    <p>{name}</p>                </div>                <div class="col">                    <label>Type</label>                    <p>{type}</p>                </div>              </div>            ',
    ...
    faqs: {
      ...
      answer6: '        <p>If a borrower repays before 75% of the loan term is complete, they’ll pay you earned interest to date plus 50% of the interest due on the remainder of the term.</p>        <p>If a borrower repays after 75% of the loan term is complete, they’ll pay you 100% of the interest due on the loan.</p>      ',
      question7: 'What happens if you have to sell borrower collateral to repay me?',
      answer7: '        <p>If a borrower can’t repay, or their collateral falls to 110% of your principal and earned profit, we’ll sell the collateral to repay you. In either case, you’ll get your principal back. You’ll also get earned interest to date if the collateral is sold mid-term, or 100% of the interest due if the collateral is sold after the term ends.</p>      ',
      ...
      answer9: '        <p>Your investments join a lending reserve from which borrowers can get loans. This means you start earning interest the moment we receive your funds.</p>      '
    },
    whatCaption0: 'Match instantly',
    whatDesc0: '      <p>Your investment funds a lending pool from which borrowers get loans in return for interest. The longer you leave your money in the pool, the more interest you earn.</p>    ',
    whatCaption1: 'Invest or insure deposits',
    whatDesc1: '      <p>Earn 4% APY on your balance with Flex. Or, insure your balance up to $130,000,000 with our custodial partner, Prime Trust.</p>      <br />      <a href="https://blog.myconstant.com/flex-or-prime-trust-constant" target="_blank">Your balance, your choice.</a>',
    whatCaption3: 'Collateral backed',
    whatDesc3: `<p>Every loan is up to 200% backed by cryptocurrency collateral. To borrow $10,000, for example, a borrower must put up to $20,000 worth of cryptocurrency into escrow. Then if the borrower defaults, we sell the collateral to repay you. </p>      <br />      <p>So if borrowers default, you don’t lose a cent.</p>      <br />      <a href="https://blog.myconstant.com/how-constant-protects-money-and-collateral" target="_blank">How we protect investors' funds.</a>`,
  ...
  loanOriginators: {
    ...
    landing: {
      contentHtml: '      <p>A world of lending at your fingertips</p>      <h1>Earn up to 11% APR investing<br/> in loans from the top loan<br/> originators in the world.</h1>      <p/>      <p>Diversify your investments and multiply your returns across global lending markets. Choose an Investment Plan (Auto Invest) for easy investing or follow your own strategy (Manual Invest). All loans include the loan originator’s buy-back guarantee in case of borrower default.</p>    ',
      intro: {
        desc: {
      ...
      how: {
        ...
        desc4: '         <p>Once your funds reach the loan originator, you’ll start earning interest. This might take up to 10 business days from the date you match.</p>         <p><a style="color:#3E8DEB" href="/getPrices" target="_blank"><b>Learn more about service times</b></a></p>           ',
    ...
    faqs: {
      ...
      answer4: "<p>Before we onboard a lending company onto our platform, we conduct a thorough due diligence process and analysis of the lending company's profile, background, corporate documents, lending practice and credit policy, historical loan performance as well as their financial strengths. </p><p>During this process, we review how the lending company lends to its borrowers, how it conducts its loan monitoring as well as how it pursues the debt recovery process in the event of default. We analyze the key indicators of the lending company's operational control, risk management, and most importantly, its financial health via its audited and interim financial statements.</p><p>We also take into account management experience and qualifications and the lending company's transparency and openness. All assessments of these indicators are input into our rating model and we assign a Constant Rating to the lending company.</p>",
      question5: 'How do you calculate a loan originator’s Constant Rating?',
      answer5: '        <p>We give every loan originator a rating between A and D, A being the best. We only work with C-rated companies and above. Our rating system gives you a guide to the quality of the loans and the loan originator themselves, which determines the risk of lending to that loan originator. </p><p>To calculate a rating, we consider many factors, including (but not limited to):</p> <ul><li>Years of operation.</li><li>Country of operation.</li><li>Share of the market.</li><li>Reputation.</li><li>Growth rate.</li><li>Risk management.</li><li>Transparency.</li><li>Financial strength.</li></ul><p>We feed all the factors into an algorithmic rating system that produces a final result. However, this rating is not fixed – we regularly review and update ratings so you always have the most up-to-date information before you invest.</p><p><a href="#">Learn more about the Constant Rating system.</a> </p>         ',
      question6: 'What’s the difference between a Loan Originator loan and a crypto-backed loan?',
      answer6: '        <p>Loan Originator loans offer longer terms (6-15 months) and better interest rates (up to 11% APR). Depending on the loan originator, you might also receive monthly repayments that you can withdraw immediately, whereas crypto-backed borrowers usually repay at the end of the term.</p> <p>A Loan Originator loan is secured by the loan originator. If borrowers default for a minimum of 60 days, the loan originator will buy back the loan. This returns your principal and earned profit up to and including the 60-day default period.</p> <p>A crypto-backed loan is secured by collateral. If borrowers default or their collateral falls too much in value, we sell it to repay you. This is usually instant, depending on how quickly we can sell the collateral.</p> <p>Those are the key differences, but you can see a full comparison on our Loan Originator homepage.</p>         ',
      question7: 'How do you protect my investment on a Loan Originator loan?',
      answer7: '        <p>First, you have the loan originator’s buy-back guarantee. If borrowers default for 60 days, the loan originator will buy back the loan to return your principal and earned profit up to and including the 60-day period. However, since you rely on the loan originator’s ability to buy back the loan, we’ve given each of them a rating.</p> <p>The Constant Rating is based on the loan originator’s business and performance, including the default rate, their stake in each loan, and types of loan offered. You can use the Constant Rating to choose between loan originators, but please remember it is just a guide. A high Constant Rating doesn’t guarantee the loan originator will buy back the loan in all cases.</p><p>Like all investment, use caution and diversify.</p>',
      question8: 'Does the buy-back guarantee protect me in all cases?',
      answer8: '        <p>In most cases, but not all. Since the loan originator buys back the loan, it depends on their ability to do so, and that’s why we give them a Constant rating from A to D, A being the best. Most of the loans we offer will be C or above. </p>        <p>Also, certain countries allow borrowers to request extensions on loans. In this case, an extension isn’t considered a default, so you might wait a bit longer for your returns. If the borrower still hasn’t repaid in full by the end of the extension, the loan originator will buy back the loan as usual. </p>        ',
      ...
      answer10: '        <p>You have two options: Zelle or bank transfer, both of which are free.</p><p>Zelle is faster, but you can only send a certain amount per day. </p><p>We support both ACH and wire bank transfers for any amount. These take a day or two to reach us (depending on your bank) and then a short processing period of around 1 business day before it appears in your account.</p> <p>Once we receive your funds, we then forward them to the loan originator. This might take 3 to 10 business days depending on the loan originator, as some of them only do weekly settlement. We’ll let you know as soon as your funds have been matched and you’ve started earning interest.</p><p>For more information, please check our service times. </p>        ',
      ...
      answer14: '<p>Matching is usually instant, but you won’t start earning interest until your funds reach the loan originator. This will involve an international bank transfer. Also, some loan originators do weekly settlement only.</p> <p>For guidance, you’ll start earning interest within 3-10 business days. </p>',
      question15: 'When do I start earning interest on a Loan Originator loan?',
      answer15: '        <p>You start earning interest as soon as your funds reach the loan originator. This takes 3-10 business days after you’ve matched with a borrower. </p><p>Depending on the loan originator, you might be able to withdraw your interest earnings periodically, perhaps monthly. In other cases, you might need to wait until the end of your term before you can withdraw your earnings.</p> <p>In either case, some loan originators do weekly settlement, which combined with international transfer times, mean it could take 3-10 business days before you can withdraw any repayments.</p>  ',
  ...
  deposit: {
    what: {
      ...
      whatDesc1: '<p>Earn {interest}% APY between fixed-term investments. Compounded and paid every second.</p>',
      whatCaption2: 'Unlimited earnings',
      whatDesc2: '<p>No maximum deposit, no maximum term. Invest from just $10 and withdraw anytime. </p>',
  ...
  ourStory: {
    ...
    b1: {
      ...
      content1: '        <p>If it’s your first time here, I’d love to tell you a little about who we are and what we do.</p>        <p>Like many stories, ours has a few twists and turns. So let’s rewind to January 2019 when it all began…</p>        <p>Back then, we were a humble stablecoin project. A team of economists, engineers, and creatives looking to make money more useful.</p>      '
    },
    b2: {
      time: 'CES 2019',
      title1: 'Back then, we were a humble stablecoin project',
      content1: '        <p>We had developed an efficient, borderless, and stable digital currency, backed by the US Dollar, which we launched at CES 2019 in Las Vegas.</p>        <p>Our stablecoin (CONST) offered stability for people in troubled economies:</p>        <p>- It cut the cost of international transfers.</p>        <p>- It slashed processing times from days to minutes.</p>        <p>- gave everyone access to a free USD account.</p>        <p>But we wanted to do more…</p>      '
    },
    b3: {
      title1: 'We wanted to help people grow their money.',
      content1: '        <p>Like the rest of the world, we’d experienced first-hand the problems with traditional banking. The miserable interest rates, the huge fees, the slow, inefficient systems…</p>        <p>So, we began thinking about how we could pay a great interest rate on our stablecoin.</p>        <p>Digital currencies are versatile. They move quickly, freely, and are protected by the blockchain technology underpinning them – surely we could put those efficiency savings to work?</p>        <p>After a lot of discussion, we set our sights on an industry that – until now – has had a mixed reputation: peer-to-peer (P2P) lending. </p>        <p>The problem with P2P lending, as we saw it, was too much centralization and too little use of collateral. P2P lenders were doing what banks did – setting rates, evaluating risk, and so on. </p>        <p>Ultimately, this takes control away from you, the customer. </p>        <p>So, we built a P2P lending platform that would do two things:</p>      ',
      missions: {
        '1': {
          title: '1',
          content: '            <p><strong>Give you control</strong> over amounts, rates, and terms.</p>            <p>We’re the only P2P lending platform in the world to offer this (as far as we know).</p>          '
        },
        '2': {
          title: '2',
          content: '            <p><strong>Secure all lending</strong> with collateral. This protects your funds and means we never do credit checks.</p>          '
        }
      }
    },
    b4: {
  ...
  affiliates: {
    ...
    faqs: {
      ...
      '8': {
        ...
        answer: '          <p>          You can’t make false or misleading statements about Constant, or use Constant keywords in Google ads. Neither can you use visitor exchange systems, forced clicks, and other methods that lead to unqualified traffic. You are not allowed to send spam with Constant ads or use other aggressive marketing methods. If you use any of these methods, your affiliate account will permanently cancelled.          </p>          '
      },
      '9': {
  ...
  transfer: {
    info: {
      content: '      <h2>Send money to anyone, anywhere.</h2>      <p/>      <p>All you need is an internet connection to make as many transfers as you like - any amount, anywhere in the world. Send money home, pay your international clients, transfer salaries to your distributed team. With a single click.</p>      <p>Note: only use this feature when you want to transfer money between Constant accounts.</p>      '
    }
  },
  yourReferral: {
    invite: {
    ...
    banner: {
      ...
      descNotUS: '        <h2>Refer friends and earn {referralFlexReward}% of their Flex interest</h2>        <p>Tell your friends and family about us and <strong>get {referralFlexReward}% of their Flex interest</strong> (US referees only) when they sign up and deposit USD. Refer as many friends as you like, however you like, and <strong>grow your money together</strong>.</p>      ',
      invite: 'Invite now'
    },
    whatForYou: {
      ...
      descNotUS: '        <div class="section-desc-title">INVITE FRIENDS, EARN TOGETHER</div>        <div><strong>Earn {referralFlexReward}% of their Flex interest</strong>, capped at a generous $1,000,000.</div>        <div><strong>Your friend gets a 30-day ${kYCTrialAmount} trial bonus</strong> and keeps the interest (US referees only).</div>      ',
      data: {
        '0': {
          title: 'EARN TOGETHER',
    ...
    whatForThem: {
      ...
      content: {
        ...
        right: '          <div>            <div class="content-title">4% APY</div>            <p class="content-desc">on all <strong>Flex</strong> deposits</p>          </div>          <div>            <div class="content-title">7.5% APR</div>            <p class="content-desc">on <strong>crypto-backed</strong> investments</p>          </div>          <div>            <div class="content-title">11% APR</div>            <p class="content-desc">on <strong>Loan Originator</strong> investments</p>          </div>        '
      }
    },
    howItWorks: {
      title: 'How it works',
    ...
    terms: {
      normal: '        <h3 class="semiBold">Terms and Conditions</h3>        <ol>          <li><p>To qualify for referral rewards, such as the ${referralReward} bonus and {referralFlexReward}% of your referee’s Flex interest, your referee must be a US citizen.</p></li>          <li><p>The bonus is paid when your referee signs up, passes KYC, and deposits USD.</p></li>          <li><p>Your referral interest is calculated on the interest your friends earn with our Flex account.</p></li>          <li><p>Referral interest is paid to you by Constant and does not deduct from your friends’ earned Flex interest.</p></li>          <li>            <p>The amount you earn depends on how your friends use the platform:</p>            <p>You earn {referralFlexReward}% of your friends’ earned Flex interest during their first year. We pay this interest every second that your friends are earning. (Your friends can also refer others to boost your and their earnings, too).</p>          </li>          <li><p>You can invite as many friends as you like.</p></li>          <li><p>Your referral earnings are paid in USD, directly into your Constant account.</p></li>          <li><p>The maximum you can earn is $1,000,000.</p></li>          <li><p>You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p></li>          <li><p>When 365 days have passed following your friend’s sign-up, you’ll no longer earn on their Flex interest. For example, on the 366th day, you won\'t earn interest but on the 365th one you will.</p></li>          <li><p>For friends referred before the effective date (2020/02/17), you’ll earn on their Flex transactions after the effective date only.</p></li>          <li><p>Constant reserves the right to change the terms of the referral program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p></li>        </ol>        <p class="bold effective">Effective as of 2020/02/17 00:00 AM (GMT+0)</p>      ',
      normalNotUS: `        <h3 class="semiBold">Terms and Conditions</h3>        <ol>          <li><p>To qualify for {referralFlexReward}% of your referee’s Flex interest, your referee must be a US citizen.</p></li>          <li><p>You will start earning {referralFlexReward}% of your referee’s Flex interest when they sign up, pass KYC, and deposit USD (minimum $10).</p></li>          <li><p>Your referral interest is calculated on the interest your friends earn with our Flex account.</p></li>          <li><p>Referral interest is paid to you by Constant and does not deduct from your friends’ earned Flex interest.</p></li>          <li>            <p>The amount you earn depends on how your friends use the platform:</p>            <p>You earn {referralFlexReward}% of your friends’ earned Flex interest during their first year. We pay this interest every second that your friends are earning. (Your friends can also refer others to boost your and their earnings, too).</p>          </li>          <li><p>You can invite as many friends as you like.</p></li>          <li><p>Your referral earnings are paid in USD, directly into your Constant account.</p></li>          <li><p>The maximum you can earn is $1,000,000.</p></li>          <li><p>You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p></li>          <li><p>When 365 days have passed following your friend’s sign-up, you’ll no longer earn on their Flex interest. For example, on the 366th day, you won't earn interest but on the 365th one you will.</p></li>          <li><p>For friends referred before the effective date (2020/02/17), you’ll earn on their Flex transactions after the effective date only.</p></li>          <li><p>Constant reserves the right to change the terms of the referral program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p></li>        </ol>        <p class="bold effective">Effective as of 2020/02/17 00:00 AM (GMT+0)</p>      `
    }
  },
  landingProReferral: {
    inviteEmail: {
  ...
  landingPage: {
    steadyGrowth: {
      title: '        <p class="header">Start growing at 7.5% APR today.</p>        <p>Don’t fall with the market. Enjoy steady growth with fully-backed P2P lending. No fees. Free withdrawals.</p>        <p>Start investing from just $50.</p>      '
    },
    ...
    howItWorks: {
      ...
      data: {
        '0': {
          title: 'Step 1',
          desc: '            <p>Sign up for your free Constant account.</p>            '
        },
        '1': {
          title: 'Step 2',
          desc: '            <p>Create your Crypto-backed or Loan Originator investment order.</p>            '
        },
        '2': {
          title: 'Step 3',
          desc: '            <p>We’ll match you with a borrower on your terms.</p>            '
        },
        '3': {
          title: 'Step 4',
          desc: '            <p>Earn interest for the duration of your term.</p>            '
        },
        '4': {
          title: 'Step 5',
    ...
    howWeProtectYou: {
      ...
      data: {
        '0': {
          desc: '            <p>Prime Trust is the accredited custodian of our USD reserve. When you deposit, your unloaned funds are stored across multiple bank accounts <strong>insured to a total of $130,000,000.</strong> So no matter what happens to us, you can still retrieve your funds.</p>            '
        },
        '1': {
          desc: '            <p>When investing in crypto-backed loans, your funds are <strong>150% backed by digital assets.</strong> If borrowers default or their collateral falls in value the collateral is sold to repay you.</p>            <p>For Loan Originator investments, <strong>all loans come with the loan originator’s buy-back guarantee.</strong> The originator promises to repay investors their principal and interest if borrowers default for 60 days or more.</p>            '
        }
      }
    },
    whyPeopleLoveUs: { title: 'Why People Love Us' },
    trialBonus: {
      title: '        <p class="header">See what it’s like to grow ${kYCTrialAmount} by the second.</p>        <p>Today when you sign up and verify your ID, we’ll deposit ${kYCTrialAmount} into your account to earn 4% APY for 30 days. At the end of 30 days, we’ll take the ${kYCTrialAmount} back but you can keep the interest and use it how you want.</p>        <p>Use your earnings to grow at 7.5% or more with our other investment tools.</p>        <p>You can start investing from just $50.</p>        <p>This offer is only available for a limited time.</p>      '
    },
    promotionGeneral: {
      ...
      howItWorks: {
        ...
        data: {
          ...
          '4': {
            title: 'Step 5',
            desc: '            <p>Reinvest your earnings or withdraw to your bank account.</p>            '
          }
        }
      },
      howWeProtectYou: {
        ...
        data: {
          ...
          '1': {
            desc: '            <p>When you invest in P2P lending through Constant, your investment is <strong>up to 200% backed by collateral</strong>. If borrowers default or their collateral falls too much in value, we sell their collateral to repay you.</p>            '
          }
        }
      }
    },
    promotionCryptoBacked: {
      title: '        <p class="header">Try secured P2P lending with a free ${kYCTrialAmount} bonus</p>        <p>Earn up to 7.5% APR with crypto-backed P2P lending. Sign up now to get a free ${kYCTrialAmount} bonus at 4% APY to start. After 30 days, we reclaim the bonus but you keep the interest.</p>        <p>This offer is only available for a limited time.</p>      ',
      howItWorks: {
        title: 'How It Works',
        data: {
          '0': {
          ...
          '4': {
            title: 'Step 5',
            desc: '            <p>Reinvest at 7.5% APR or withdraw earnings to your bank account.</p>            '
          }
        }
      },
      howWeProtectYou: {
        ...
        data: {
          ...
          '1': {
            desc: '            <p>When you invest in Flex, your money supplies loans to collateralized borrowers and liquidity to decentralized exchanges. <strong>Flex is a multi-market investment product</strong> that spreads risk across multiple platforms to offer you a consistent return and the convenience of unlimited free withdrawals.</p>            '
          }
        }
      }
    },
    promotionFlex: {
      title: '        <p class="header">Get 4% APY on your free ${kYCTrialAmount} bonus now</p>        <p>Enjoy up to 50x better interest than a bank with Flex, our anytime-withdrawal investment account. Sign up now to get a free ${kYCTrialAmount} bonus to start. After 30 days, we reclaim the bonus but you keep the interest.</p>        <p>This offer is only available for a limited time.</p>      ',
      howItWorks: {
        title: 'How It Works',
        data: {
          '0': {
  ...
  badges: {
    ...
    badge: {
      ...
      referring_invest_100k: {
        ...
        condition: "          When a referee of yours invests a total of $100,000 in matched Crypto-Backed or Loan Originator Investments, you earn this Bronze badge and a $20 bonus.          <br/>Each badge is limited to one referee only (the same referee can't be used to earn all three badges).        ",
        name: 'Luminary (Bronze)'
      },
      referring_invest_200k: {
        title: 'Your referee invests $200,000',
        condition: "          When a referee of yours invests a total of $200,000 in matched Crypto-Backed or Loan Originator Investments, you earn this Silver badge and a $40 bonus.          <br/>Each badge is limited to one referee only (the same referee can't be used to earn all three badges).        ",
        name: 'Luminary (Silver)'
      },
      referring_invest_500k: {
        title: 'Your referee invests $500,000',
        condition: "          When a referee of yours invests a total of $500,000 in matched Crypto-Backed or Loan Originator Investments, you earn this Gold badge and a $100 bonus.          <br/>Each badge is limited to one referee only (the same referee can't be used to earn all three badges).        ",
        name: 'Luminary (Gold)'
      },
      referring_article_first: {
        title: 'Write your first article or review about Constant',
        condition: "          To qualify for badges and rewards, your article must be at least 700 words, unique, and without plagiarism. You must publish articles on your registered site, and only one article per month will qualify.          </br>If you publish articles sooner and don't meet the monthly quota, you won't receive a reward. We reserve the right to evaluate your articles for quality and readability before approving your badges.         ",
