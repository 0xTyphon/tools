const result =  {
  ...
  'home.constantC2CLoan.why.whatDesc0': '          <p>Our P2P matching algorithm allows you to tap into true market demand. Choose the market rate to guarantee a match, or go higher to match even faster.</p>        ',
  ...
  'affiliates.applyForm.title': '<p class="header">Get paid for your content.</p>        <p>Become a Constant affiliate and earn money on your content. <strong>Get $30</strong><sup>1</sup> for every person<sup>2</sup> you refer plus <strong>20% of their Flex interest in their first year</strong> (capped at $1 million). Refer as many people as you like. </p>',
  'affiliates.applyForm.titleDesc': '<p class="reference clearBottom"><sup>1</sup> Valid until the end of August</p><p class="reference"><sup>2</sup> To qualify for the $30 reward, your referee must be a US citizen (see Affiliate Terms and Conditions).</p>',
  ...
  'affiliates.howItWorks.data.2.desc': 'You get $30 paid instantly to your Constant account.',
  ...
  'affiliates.howItWorks.desc': '<p>There are <strong>no limits</strong> to the number of people you can refer for the $30 bonus.</p>      <p>Your Flex earnings are capped at $1,000,000.</p>',
  ...
  'affiliates.greetingForm.title': '        <p class="header">Hello {name},</p>        <p>Welcome to your affiliate dashboard. You’ll find your affiliate link and sharing options below. You can track your earnings here, too.</p>        <p>Your total referral earnings to date: <strong>${totalEarned}</strong>.</p>      ',
  'affiliates.terms.content': `        <p class="section-title">Terms and Conditions</p>        <p>1. The amount you earn depends on how your referees use the platform:</p>        <p class="desc">You earn 20% of your referees’ earned Flex interest. We pay this interest every second that your referees earn.</p>        <p>2. We will pay you $30 for every person who signs up using your referral link, passes KYC and makes a deposit into Constant. If they don't meet these requirements, you don't earn the $30 bonus.</p>        <p>3. Your referral earnings are paid in USD, directly into your Constant account.</p>        <p>4. The maximum affiliate interest you can earn through Flex is $1,000,000.</p>        <p>5. You can’t self-invite by creating multiple accounts. If we detect such activity, all referrals and earnings (if any) will be forfeit.</p>        <p>6. If you make false or misleading statements about Constant, use Constant keywords in Google ads, use visitor exchange systems, forced clicks, and other methods that lead to unqualified traffic, send spam with Constant ads or use other aggressive marketing methods, your affiliate earnings will be forfeit and your membership cancelled.</p>        <p>7. To qualify for affiliate earnings, your referees must be US citizens.</p>        <p>8. Constant reserves the right to change the terms of the affiliate program at any time due to changing market conditions, risk of fraud, or any other factors we deem relevant.</p>      `,
