const result =  {
  ...
  'home1.lendingSection.confirm.paymentMethods.email.notAvailableAmount': '<p>The maximum amount you can send through Zelle is {amount}. Please choose either a wire transfer or ACH transfer (available for linked US bank accounts only).</p><p><a href="#">How to link a US bank account for ACH transfers.</a></p>',
  ...
  'home1.lendingSection.confirm.paymentMethods.plaid.notAvailableAmount': '<p>The maximum amount you can send via ACH is {amount}. Please choose a wire transfer. For more information on ACH limits, please read our <a href="#">Guide to Linking US Bank Accounts.</a></p>',
  ...
  'me.bankInfo.linkBankSectionDesc': '<p>Deposit or withdraw using ACH bank transfers with Plaid. Link up to two bank accounts now to save time and money transferring funds to and from your Constant account. Since most savings accounts limit the number of withdrawals, we recommend you link a checking account not a savings account to avoid ACH reversals. <a href="#">How to avoid ACH reversals</a>.</p> <p><strong>*Please note: For your security, you must withdraw to the same bank account from which you made your deposit. This restriction applies for 60 days and can be lifted upon supplying additional verification information. <a href="#">How linked banking works</a>.</strong></p> <p>To get started, click <strong>+ Add new bank</strong>.',
