const result =  {
  ...
  'affiliates.applyForm.title': '        <p class="header">Get paid for your content.</p>        <p>Become a Constant affiliate and earn money on your content. <strong>Get $20</strong> for every person<sup>1</sup> you refer plus <strong>20% of their Flex interest in their first year</strong> (capped at $1 million). Refer as many people as you like. </p>      ',
  'affiliates.applyForm.titleDesc': '      <p class="reference"><sup>1</sup> To qualify for the $20 reward, your referee must be a US citizen (see Affiliate Terms and Conditions).</p>      ',
  ...
  'affiliates.howItWorks.desc': '      <p>There are <strong>no limits</strong> to the number of people you can refer for the $20 bonus.</p>      <p>Your Flex earnings are capped at $1,000,000.</p>',
