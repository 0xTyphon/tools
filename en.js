const result =  {
  ...
  'home1.lendingSection.confirm.paymentMethods.primetrust.desc': '            <p class="title"><strong>Important info for Prime Trust transfers</strong></p>            <p class="desc">Prime Trust only accepts wire transfers, not ACH. Make sure you complete a wire transfer from your personal bank account or we might be unable to locate your funds.</p>            <p class="desc">For more information on transferring to Prime Trust, <a href="https://blog.myconstant.com/how-to-wire-your-money-to-constant-via-prime-trust/" target="_blank" class="underline">check out our blog</a>. It’s vital you include your reference number when you wire the money so we can match it to your account.</p>            <p class="desc">When you have made your transfer, please send an email with your wire receipt to <a href="mailto:hello@myconstant.com" target="_blank" class="underline">hello@myconstant.com</a> to help us speed up the process. Your wire receipt, sometimes called a transaction confirmation, holds all the details of the transfer and might be emailed to you or be made available through online banking.</p>            ',
  ...
  'badges.group.membership_desc': `We'd love that you choose Constant and use our platform for a long time. In order to award each member, we have three tiers for membership. Depending on the level of membership, you will have different privileges. Please <a href="/membership">click here></a> for full details.`,
