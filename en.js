const result =  {
  ...
  'me.bankInfo.linkBankSectionDesc': '<p>Deposit or withdraw using ACH bank transfers with Plaid. Link up to two bank accounts now to save time and money transferring funds to and from your Constant account. Since most savings accounts limit the number of withdrawals, we recommend you link a checking account not a savings account to avoid ACH reversals. <a href="https://blog.myconstant.com/how-to-link-your-bank-account-for-ach-transfers-on-constant/">How to avoid ACH reversals</a>.</p> <p><strong>*Please note: For your security, you must withdraw to the same bank account from which you made your deposit. This restriction applies for 60 days and can be lifted upon supplying additional verification information. <a href="#">How linked banking works</a>.</strong></p> <p>To get started, click <strong>+ Add new bank</strong>.',
  'me.bankInfo.unlinkBankSectionTitle': 'Add an unlinked bank account for manual transfers',
  'me.bankInfo.unlinkBankSectionDesc': '<p>If you want to send more than $5,000 per transaction, or if your bank is outside of the US or doesn\'t support ACH transfers through Plaid, please add alternative banking details below. You can then preselect these details the next time you create a withdrawal order.</p> <p><strong>*Please note: We can\'t accept ACH transfers from unlinked bank accounts. If you send an ACH transfer from an unlinked bank account, it will be returned to you according to your bank’s schedule. Please only use Zelle or wire transfer only.</strong></p> <p>To get started, click <strong>+ Add new bank</strong>.',
